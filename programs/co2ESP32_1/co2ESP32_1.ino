...
#define TX_PIN 25               // Tx pin which the MHZ19 Rx pin is attached to
#define BAUDRATE 9600           // Native to the sensor (do not change)

// WiFi private network credentials.
//char ssid[] = "INFINITUM36B2_2.4";
//char wifiPassword[] = "62JApCPFNq";

char ssid[] = "Gutierrez";
char wifiPassword[] = "4499783398";

// Cayenne authentication info. This can be obtained from the Cayenne Dashboard.
char username[] = "81f7a3f0-b919-11e6-85fb-51e12662ad94";
char password[] = "1236073e7defc92602a00c7025dba7935a95fd8a";
char clientID[] = "833269a0-9973-11eb-8779-7d56e82df461";

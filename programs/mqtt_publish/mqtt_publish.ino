...
const char* ssid = "INFINITUM36B2_2.4"; // Wifi SSID
const char* password = "62JApCPFNq"; // Wifi Password
const char* username = "sebastiangtz"; // my AskSensors username
const char* pubTopic = "publish/sebastiangtz/2ZNLgn5tbS4oY7sxvaOxMG6hEYFwciP5"; // publish/username/apiKeyIn
